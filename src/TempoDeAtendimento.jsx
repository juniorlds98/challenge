    ...
    return (
        <div>
            <div className="flex w-full border border-black bg-[#818084] p-4 text-white">
                <div className="flex ml-[310px] items-center w-full space-x-[100px]">
                    ...
                    <div className='col-12 col-lg-8'>
                        ...
                        <div className='flex flex-row gap-8'>
                            {tipos.map((item) => (
                                <div
                                key={item.tipo}
                                className={`painel ${item.tipo.toLowerCase().replace(/\s/g, '-')}`}
                                >
                        ...
                        <div>
                        * Informamos que o tempo de espera pode variar em decorrência da complexidade de atendimento dos <br />pacientes ou emergências. <span className='underline'>Clique aqui</span> para conferir os dias e horários mais movimentados do hospital.
                        </div>
                    </div>
                </div>
